    ...
    <div class="shop_cart">
        <div class="cart_style">
            <div class="title_name">
                <ul>
                    <li class="title_width"><label class="auto-label"><input type="checkbox"
                                                                             id="all_selected"><span>全选</span></label>
                    </li>
                    ...
                    <#if CartVo.cartProductVoList?size gt 0>
                        <#list CartVo.cartProductVoList as cartProductVo>
                            <ul class="product_cart">
                                <li class="title_width"><input type="checkbox" class="check-box"
                                                               tips="${cartProductVo.productId!""}"></li>
                                <li class="title_width1">
                                    <a href="/home/product/detail?id=${cartProductVo.productId!""}"
                                       class="product_img left"><img
                                                src="/photo/view?filename=${cartProductVo.productPic!""}" width="100px"
                                                height="100px"/></a>
                                    <p class="cart_content" style="text-align: center">
                                        <a href="/home/product/detail?id=${cartProductVo.productId!""}"
                                           class="title_name">${cartProductVo.productName!""}</a>
                                    </p>
                                </li>
                                <li class="title_width2">￥${cartProductVo.price!""}</li>
                                <li class="title_width3">
                                    <div class="Numbers">
                                        <a href="javascript:void(0);" onclick="reduce(${cartProductVo.productId!""});"
                                           class="jian">-</a>
                                        <input id="number${cartProductVo.productId!""}" name="number"
                                               readonly="readonly" type="text" value="${cartProductVo.quantity!""}"
                                               class="number_text">
                                        <a href="javascript:void(0);" onclick="add(${cartProductVo.productId!""});"
                                           class="jia">+</a>
                                    </div>
                                </li>
                                <li class="title_width4">￥${cartProductVo.productTotalPrice!""}</li>
                                <li class="title_width5"><a href="javascript:void(0);"
                                                            onclick="delCartProduct(${cartProductVo.productId!""});">删除</a>
                                </li>
                            </ul>
                        </#list>
                    </#if>
        ...
        <div class="cart_operating clearfix">
            <div class="cart_operating_style">
                ...
                <div class="cart_btn"><a href="javascript:void(0);" onclick="generateOrder();"
                                         class="payment_btn"></a><a href="/home/product/fruit" class="continue_btn"></a>
                </div>
            </div>
        </div>
    </div>
