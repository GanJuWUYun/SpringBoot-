    ...
    <div class="vegetables_Forum">
        <div class="title_style">
            ...
            <div class="title_info">
                ...
                <p class="x_info">
                    蔬菜有很多的种类，不过每种都含有很多营养成分，营养元素，利于身体健康。它的种类大致可分为根菜类，叶菜类，瓜类，蘑菇类以及豆类等。一般颜色深的蔬菜都含有铁和维生素A，颜色越深含量就越高。且里面的脂肪，糖类，蛋白质的含量少，即便是多吃也不会对身体造成负担。</p>
            </div>
                    ...
                    <#list PageInfo.list as product>
                        <li class="clearfix">
                            <div class="product_lists clearfix">
                                <a href="/home/product/detail?id=${product.id!""}"><img
                                            src="/photo/view?filename=${product.productPic!""}" width="207px"
                                            height="219px"/></a>
                                <a href="javascript:void(0);" onclick="addCollect(${product.id!""});" title="添加收藏"
                                   class="Collect"></a>
                                <p class="title_p_name">${product.productName!""}</p>
                                <p class="title_Profile">${product.info!""}</p>
                                <p class="price">￥${product.price!""} 元/箱</p>
                                <p class="btn_style"><a href="javascript:void(0);" onclick="addCart(${product.id!""});"
                                                        class="Join_btn"></a></p>
                            </div>
                        </li>
                    </#list>
