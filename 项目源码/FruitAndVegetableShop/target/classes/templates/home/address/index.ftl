                ...
                <div class="about_user_info">
                    <form id="add_address_form">
                        <div class="user_layout">
                            <ul>
                                <li><label class="user_title_name">收件人姓名：</label><input name="receiverName" type="text"
                                                                                        class="add_text required"
                                                                                        placeholder="请输入收货人姓名"
                                                                                        tips="收货人姓名不能为空！"><em>*</em>
                                </li>
                                <li><label class="user_title_name">收货人地址：</label><input name="receiverAddress"
                                                                                        type="text"
                                                                                        class="add_text required"
                                                                                        placeholder="请输入收货人地址"
                                                                                        tips="收货人地址不能为空！"><em>*</em>
                                </li>
                                <li><label class="user_title_name">收货人手机：</label><input name="receiverPhone" type="text"
                                                                                        class="add_text required"
                                                                                        placeholder="请输入收货人电话"
                                                                                        tips="收货人电话不能为空！"><em>*</em>
                                </li>
                            </ul>
                            <div class="operating_btn"><input id="add_address_button" type="button" value="添加"
                                    ...
                                    <td>
                                        <#if address.firstSelected == 0>
                                            ...
                                            <a href="javascript:void(0);"
                                               onclick="deleteAddress(${address.id!""});">删除</a>
                                        <#else>
