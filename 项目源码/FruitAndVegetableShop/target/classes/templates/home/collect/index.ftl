                            ...
                            <#list PageInfo.list as collect>
                                <li>
                                    <div class="Collect_pro_name">
                                        <a href="javascript:void(0);" onclick="deleteCollect(${collect.id!""});"
                                           class="delete_Collect"></a>
                                        <p class="img center"><a
                                                    href="/home/product/detail?id=${collect.product.id!""}"><img
                                                        src="/photo/view?filename=${collect.product.productPic!""}"/></a>
                                        </p>
                                        <p>
                                            <a href="/home/product/detail?id=${collect.product.id!""}">${collect.product.productName!""}</a>
                                        </p>
