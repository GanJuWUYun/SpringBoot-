    ...
    <div class="Orders_style clearfix">
        <div class="address clearfix">
            ...
            <div class="adderss_list clearfix">
                <div class="title_name">选择收货地址 <a href="/home/address/index">+选择地址</a><a href="javascript:void(0);"
                                                                                         onclick="location.reload();">刷新地址</a>
                </div>
            ...
            <form class="form" method="post">
                <fieldset>
                    ...
                    <div class="Product_List">
                                ...
                                <#list Order.orderItemList as orderItem>
                                    <tr>
                                        <td class="Product_info">
                                            <a href="/home/product/detail?id=${orderItem.productId!""}"><img
                                                        src="/photo/view?filename=${orderItem.productPic!""}"
                                                        width="100px" height="100px"/></a>
                                            <a href="/home/product/detail?id=${orderItem.productId!""}"
                                               class="product_name">${orderItem.productName!""}</a>
                                        </td>
                        ...
                        <div class="Pay_info">
                            <label>订单留言</label><input id="remark" type="text" class="text_name "
                                                      placeholder="请输入50字以内的订单留言"/>
                        </div>
                        <!--价格-->
                            ...
                            <div class="right_direction">
                                <ul>
                                    ...
                                    <li class="shiji_price">
                                        <label>实&nbsp;&nbsp;付&nbsp;&nbsp;款</label><i>￥</i><span>${Order.totalPrice!""}</span>
                                    </li>
                                </ul>
                                <div class="btn"><input onclick="submitOrder(${Order.id!""});" type="button"
                                                        value="提交订单" class="submit_btn"/> <input onclick="backCart();"
                                                                                                 type="button"
                                                                                                 value="返回购物车"
                                                                                                 class="return_btn"/>
                                </div>
