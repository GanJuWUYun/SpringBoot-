                        ...
                        <#list FirstMenus as firstMenu>
                            <tr>
                                <td style="width:150px;">
                                    <input id="${firstMenu.id!""}" style="vertical-align:middle;" type="checkbox"
                                           name="id[]" lay-skin="primary" lay-filter="father"
                                           value="${firstMenu.id!""}">
                                                                ...
                                                                <#if ThirdMenus?size gt 0>
                                                                    <#list ThirdMenus as thirdMenu>
                                                                        <#if thirdMenu.parentId == secondMenu.id>
                                                                            <input id="${thirdMenu.id!""}"
                                                                                   style="vertical-align:middle;"
                                                                                   name="id[]" lay-skin="primary"
                                                                                   type="checkbox"
                                                                                   value="${thirdMenu.id!""}">
