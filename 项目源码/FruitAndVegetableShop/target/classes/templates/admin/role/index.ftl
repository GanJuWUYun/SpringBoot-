                            ...
                            <#list PageInfo.list as role>
                                <tr>
                                    <td style="text-align:center">
                                        <input type="checkbox" name="" id="${role.id!""}" method="checkedId"
                                               lay-skin="primary">
                                    </td>
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn-warm layui-btn-xs"
                                                onclick="xadmin.open('权限编辑','/admin/role/authority?id=${role.id!""}',900,500)">
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            ...
                            <#else>
                                <a class="prev"
                                   href="/admin/role/index?id=${currentMenu.id!""}&pageNum=${PageInfo.prePage!""}&name=${name!""}">&lt;&lt;</a>
                            </#if>
                            <#list PageInfo.pageNum-2..PageInfo.pageNum-1 as i>
                                <#if i gte 1>
                                    <a class="num"
                                       href="/admin/role/index?id=${currentMenu.id!""}&pageNum=${i!""}&name=${name!""}">${i!""}</a>
                                </#if>
                            </#list>
                            ...
                            <#else>
                                <a class="next"
                                   href="/admin/role/index?id=${currentMenu.id!""}&pageNum=${PageInfo.nextPage!""}&name=${name!""}">&gt;&gt;</a>
                            </#if>
                        </div>
                    </div>
                </div>
