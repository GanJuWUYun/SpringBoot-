                            ...
                            <#list PageInfo.list as admin>
                                <tr>
                                    <td style="text-align:center">
                                        <input type="checkbox" name="" id="${admin.id!""}" method="checkedId"
                                               lay-skin="primary">
                                    </td>
                                    <td style="text-align:center">${admin.id!""}</td>
                                    <td style="text-align:center">
                                        <img src="/photo/view?filename=${admin.headPic!""}"
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            ...
                            <#else>
                                <a class="prev"
                                   href="/admin/admin/index?id=${currentMenu.id!""}&pageNum=${PageInfo.prePage!""}&name=${name!""}">&lt;&lt;</a>
                            </#if>
                            <#list PageInfo.pageNum-2..PageInfo.pageNum-1 as i>
                                <#if i gte 1>
                                    <a class="num"
                                       href="/admin/admin/index?id=${currentMenu.id!""}&pageNum=${i!""}&name=${name!""}">${i!""}</a>
                                </#if>
                            </#list>
                            ...
                            <#else>
                                <a class="next"
                                   href="/admin/admin/index?id=${currentMenu.id!""}&pageNum=${PageInfo.nextPage!""}&name=${name!""}">&gt;&gt;</a>
                            </#if>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function changeState(i) {
        $.ajax({
            ...
            error: function () {
                layer.alert('网络错误！更改状态失败！', {icon: 5}, function () {
                    parent.window.location.reload();
                });
            }
        });
