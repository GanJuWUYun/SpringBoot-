        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="name" value="${editAdmin.name!""}" required=""
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="password" name="password" value="${editAdmin.password!""}" required=""
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <label for="headPic" class="layui-form-label">
                    管理员头像：</label>
                <img src="/photo/view?filename=${editAdmin.headPic!""}" id="preview-headPic"
                     style="width:90px;height:70px;padding-right:10px;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="mobile" name="mobile" value="${editAdmin.mobile!""}"
                           onkeyup="value=value.replace(/^0(0+)|[^\d]+/g,'')" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                <label for="address" class="layui-form-label">
                    管理员住址：</label>
                <div class="layui-input-inline">
                    <input type="text" id="address" name="address" value="${editAdmin.address!""}" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <#if editAdmin.state == 1>
                        <input type="checkbox" name="switch" method="saveState" lay-text="启用|冻结" checked
                               lay-skin="switch">
                    <#else>
