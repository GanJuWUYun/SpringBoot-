        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="${Order.user.username!""}" readonly="readonly" lay-verify="required"
            ...
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                    订单流水号：</label>
                <div class="layui-input-inline">
                    <input type="text" value="${Order.orderNo!""}" readonly="readonly" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                <label for="description" class="layui-form-label">
                    收件人姓名：</label>
                <div class="layui-input-inline">
                    <input type="text" style="width: 190px" value="${Order.address.receiverName!""}" readonly="readonly"
            ...
            <div class="layui-form-item layui-form-text">
                <label for="description" class="layui-form-label">
                    配送地址：</label>
                <div class="layui-input-inline">
                    <input type="text" style="width: 300px" value="${Order.address.receiverAddress!""}"
                           readonly="readonly" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                <label for="description" class="layui-form-label">
                    收件人手机：</label>
                <div class="layui-input-inline">
                    <input type="text" style="width: 190px" value="${Order.address.receiverPhone!""}"
                           readonly="readonly" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
                ...
                <#if OrderItemList?size gt 0>
                    <#list OrderItemList as orderItem>
                        <tr>
                            ...
                            <td style="text-align:center"><img src="/photo/view?filename=${orderItem.productPic!""}"
