                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            ...
                            <#else>
                                <a class="prev"
                                   href="/admin/mail/send?id=${currentMenu.id!""}&pageNum=${PageInfo.prePage!""}&title=${title!""}">&lt;&lt;</a>
                            </#if>
                            <#list PageInfo.pageNum-2..PageInfo.pageNum-1 as i>
                                <#if i gte 1>
                                    <a class="num"
                                       href="/admin/mail/send?id=${currentMenu.id!""}&pageNum=${i!""}&title=${title!""}">${i!""}</a>
                                </#if>
                            </#list>
                            ...
                            <#else>
                                <a class="next"
                                   href="/admin/mail/send?id=${currentMenu.id!""}&pageNum=${PageInfo.nextPage!""}&title=${title!""}">&gt;&gt;</a>
                            </#if>
                        </div>
                    </div>
                </div>
