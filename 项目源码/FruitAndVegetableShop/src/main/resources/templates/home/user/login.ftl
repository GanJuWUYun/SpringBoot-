            ...
            <form id="login_form">
                <div class="layout">
                    ...
                    <div class="item item-fore1"><label for="loginname" class="login-label name-label"></label><input
                                name="username" id="username" type="text" class="text required" placeholder="请输入用户名称"
                                tips="用户名称不能为空！"></div>
                    <div class="item item-fore2"><label for="nloginpwd" class="login-label pwd-label"></label><input
                                name="password" id="password" type="password" class="text required" placeholder="请输入密码"
                                tips="密码不能为空！"></div>
                    <div class="login-btn"><a href="javascript:void(0);" id="login_button" class="btn_login">登&nbsp;&nbsp;&nbsp;&nbsp;录</a>
                    </div>
                </div>
            </form>
        </div>
