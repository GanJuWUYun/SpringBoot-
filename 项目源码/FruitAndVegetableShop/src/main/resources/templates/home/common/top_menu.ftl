        ...
        <div class="header_Section">
            <div class="shortcut">
                <ul>
                    ...
                    <#else>
                        <li class="hd_menu_tit" id="li_login"><em class="login_img"></em><a
                                    href="/home/user/login">登录</a></li>
                    </#if>
                    <li class="hd_menu_tit"><em class="registered_img"></em><a href="/home/user/register">注册</a></li>
                    <li class="hd_menu_tit"><em class="Collect_img"></em><a href="javascript:void(0);"
                                                                            onclick="addFavorite();" title="收藏水果蔬菜商城网站">
                            收藏网站</a></li>
                    <li class="hd_menu_tit"><em class="cart_img"></em><a href="/home/cart/index">购物车（${cartTotal!"0"}
                            ）</a></li>
                </ul>
            </div>
