                ...
                <#if SellNumList?size gt 0>
                    <#list SellNumList as product>
                        <li class="">
                            ...
                            <a href="/home/product/detail?id=${product.id!""}" class="img"> <img
                                        src="/photo/view?filename=${product.productPic!""}" width="100px"
                                        height="100px"/></a>
        ...
        <div class="pro_detailed">
                            ...
                            <dd class="left">
                                <div class="Numbers">
                                    ...
                                    <input id="number" name="number" type="text" value="1"
                                           onkeyup="value=value.replace(/^0(0+)|[^\d]+/g,'')" class="number_text">
            ...
            <div class="mainListRight" id="status1">
                <ul class="fixed_bar" style="">
                    <li class="status_on active"><a
                                href="javascript:void(0);status2">商品评价<span>(${TotalComment!""})</span></a></li>
                </ul>
            </div>
            <!--发表评论-->
            <div class="commentBox" style="display: block;">
                <div class="bd">
                    <textarea name="content" id="content" style="width:943px;height: 70px; border:solid 0.5px"
                              placeholder="请输入评论内容（不得超过100字！）"></textarea>
                    <p class="g">
                        <a href="javascript:void(0)" onclick="submitComment(${Product.id!""});"><input
                                    style="position:absolute;right:100px;margin-top: 5px;" type="button" value="发表"
                                    class="btn_common"></a>
                </div>
            </div>
            <!--评论列表-->
                ...
                <#if PageInfo.list?size gt 0>
                    <#list PageInfo.list as comment>
                        <p style="margin-top: 5px;"><span
                                    style="line-height:22px;font-size:14px;color:#347BC4;">${comment.user.username!""}</span><span
                                    style="color:#888;line-height:22px;font-size:14px;">(${comment.createTime?string('yyyy-MM-dd HH:mm:ss')!""})</span>
                            <span style="position:absolute;right:100px;font-size:16px;color:#ccc;">#${x!""}</span><br><span
                                    style="color:#888;line-height:22px;font-size:14px;">${comment.content!""}</span>
                        </p>
                        <#assign x = x + 1 />
                    </#list>
                </#if>
