...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <table class="layui-table">
                        ...
                        <tr>
                            <th>运行环境</th>
                            <td>Idea2019.3.5 + jdk1.8 + MYSQL5.7 + Maven3.6.3 + Redis5.0.5</td>
                        </tr>
                        <tr>
                            <th>MYSQL版本</th>
                            <td>5.7</td>
        ...
        <div class="layui-col-md12">
            <blockquote class="layui-elem-quote layui-quote-nm" style="text-align:center">Copyright (c)2020-杨杨吖
            </blockquote>
        </div>
    </div>
</div>
