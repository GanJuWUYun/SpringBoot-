                            ...
                            <#list PageInfo.list as mail>
                                <tr>
                                    <td style="text-align:center">
                                        <input type="checkbox" name="" id="${mail.id!""}" method="checkedId"
                                               lay-skin="primary">
                                    </td>
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            ...
                            <#else>
                                <a class="prev"
                                   href="/admin/mail/receive?id=${currentMenu.id!""}&pageNum=${PageInfo.prePage!""}&title=${title!""}">&lt;&lt;</a>
                            </#if>
                            <#list PageInfo.pageNum-2..PageInfo.pageNum-1 as i>
                                <#if i gte 1>
                                    <a class="num"
                                       href="/admin/mail/receive?id=${currentMenu.id!""}&pageNum=${i!""}&title=${title!""}">${i!""}</a>
                                </#if>
                            </#list>
                            ...
                            <#else>
                                <a class="next"
                                   href="/admin/mail/receive?id=${currentMenu.id!""}&pageNum=${PageInfo.nextPage!""}&title=${title!""}">&gt;&gt;</a>
                            </#if>
                        </div>
                    </div>
                </div>
