        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="productName" name="productName" required="" placeholder="请输入商品名称"
            ...
            <div class="layui-form-item">
                <label for="headPic" class="layui-form-label">
                    商品图片：</label>
                <img src="/photo/view?filename=common/product_img.png" id="preview-productPic"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="price" name="price" onkeyup="num(this)" required="" placeholder="请输入商品价格"
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="stock" name="stock" onkeyup="value=value.replace(/^0(0+)|[^\d]+/g,'')"
                           required="" placeholder="请输入商品库存" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
