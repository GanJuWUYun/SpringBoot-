        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="productName" value="${Product.productName!""}" name="productName" required=""
                           placeholder="请输入商品名称" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <label for="headPic" class="layui-form-label">
                    商品图片：</label>
                <img src="/photo/view?filename=${Product.productPic!""}" id="preview-productPic"
                     style="width:90px;height:90px;padding-right:10px;">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入商品详情" id="info" name="info"
                              class="layui-textarea">${Product.info!""}</textarea>
                </div>
            </div>
                            ...
                            <#list productCategoryList as productCategory>
                                <#if Product.categoryId == productCategory.id>
                                    <option selected="selected"
                                            value="${productCategory.id!""}">${productCategory.categoryName!""}</option>
                                <#else>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="price" name="price" onkeyup="num(this)" value="${Product.price!""}"
                           required="" placeholder="请输入商品价格" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="stock" name="stock" onkeyup="value=value.replace(/^0(0+)|[^\d]+/g,'')"
                           value="${Product.stock!""}" required="" placeholder="请输入商品库存" lay-verify="required"
