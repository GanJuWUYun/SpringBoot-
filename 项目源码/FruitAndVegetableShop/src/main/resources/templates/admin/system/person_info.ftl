        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="name" value="${loginedAdmin.name!""}" required=""
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="password" name="password" value="${loginedAdmin.password!""}" required=""
                           lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <label for="headPic" class="layui-form-label">
                    管理员头像：</label>
                <img src="/photo/view?filename=${loginedAdmin.headPic!""}" id="preview-headPic"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="mobile" name="mobile" value="${loginedAdmin.mobile!""}"
            ...
            <div class="layui-form-item">
                <label for="address" class="layui-form-label">
                    管理员住址：</label>
                <div class="layui-input-inline">
                    <input type="text" id="address" name="address" value="${loginedAdmin.address!""}" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
