        ...
        <form id="adminLoginForm">
            <div class="login-center clearfix">
                ...
                <div class="login-center-input">
                    <input type="text" name="name" class="required" id="name" value="" placeholder="请输入您的用户名"
            ...
            <div class="login-center clearfix">
                ...
                <div class="login-center-input">
                    <input type="password" name="password" class="required" id="password" value="" placeholder="请输入您的密码"
            ...
            <div class="login-center clearfix">
                ...
                <div class="login-center-input">
                    <input style="width:50%;" type="text" class="required" name="cpacha" id="cpacha" value=""
                           placeholder="请输入验证码" onfocus="this.placeholder=&#39;&#39;"
                           onblur="this.placeholder=&#39;请输入验证码&#39;" tips="验证码不能为空">
                    <div class="login-center-input-text">验证码</div>
                    <img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;"
                         src="/common/cpacha/generate_cpacha?vl=4&fs=21&w=98&h=33&method=admin_login" width="110px"
