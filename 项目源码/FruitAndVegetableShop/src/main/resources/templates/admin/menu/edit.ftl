        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="name" name="name" value="${editMenu.name!""}" required=""
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="sort" name="sort" onkeyup="value=value.replace(/^0(0+)|[^\d]+/g,'')"
                           required="" value="${editMenu.sort!""}" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <label for="url" class="layui-form-label">
                    菜单路径：</label>
                <div class="layui-input-inline">
                    <input type="text" id="url" name="url" value="${editMenu.url!""}" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
                                ...
                                <#list FirstMenus as firstMenu>
                                    <#if firstMenu.id == editMenu.parentId>
                                        <option selected="selected"
                                                value="${firstMenu.id!""}">${firstMenu.name!""}</option>
                                    <#else>
                            ...
                            <#if SecondMenus?size gt 0>
                                <#list SecondMenus as secondMenu>
                                    <#if secondMenu.id == editMenu.parentId>
                                        <option selected="selected"
                                                value="${secondMenu.id!""}">${secondMenu.name!""}</option>
                                    <#else>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="icon" name="icon" readonly="readonly" autocomplete="off" required=""
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <#if editMenu.state == 1>
                        <input type="checkbox" name="switch" method="saveState" lay-text="开启|停用" checked
                               lay-skin="switch">
                    <#else>
